...
After the object is retrieved, K3cms_InlineEditor will attempt to call {object_name}.updatePage(object_name, object) if this method exists. For example, if the 'object' option for your inline editor is 'book', it will attempt to call book.updatePage(), passing in the object_name and object.
